...
public:
	...
	// 변수 생성 모든 객체에서 접근할 수 있도록 하기 위해 static으로 선언
	// static은 heap에 선언이 되기 때문에 모든 객체에서 접근 가능.
	My_cat();
